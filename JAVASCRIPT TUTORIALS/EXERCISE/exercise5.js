...
meanings.addEventListener("click",()=>{
    console.log("someone click on meanings");
    populate();
})
...
function populate(params){
    ...
    results.forEach(element => {
        ...
        // html+=`<a href="#" class="list-group-item list-group-item-action list-group-item-danger">one of the definition of example is ${element.definition}</a>`
